...
public static class UserSettingsStore
{
    ...
    private static UserSettings ParseSettings(JsonElement root, UserSettings defaults)
    {
        ...
        return new UserSettings
        {
            ...
            GenerateCoolerSnake = ReadBool(root, nameof(UserSettings.GenerateCoolerSnake), defaults.GenerateCoolerSnake),
            ShowCoolerOverlay = ReadBool(root, nameof(UserSettings.ShowCoolerOverlay), defaults.ShowCoolerOverlay),
            ...
            ExportExtraLayersBasic = ReadEnum(root, nameof(UserSettings.ExportExtraLayersBasic), defaults.ExportExtraLayersBasic),
            ExportExtraLayersFiveClip = ReadEnum(root, nameof(UserSettings.ExportExtraLayersFiveClip), defaults.ExportExtraLayersFiveClip),
